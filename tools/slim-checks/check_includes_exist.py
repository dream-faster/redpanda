...
for f in files:
    ...
    for i, line in enumerate(src.split("\n"), 1):
        ...
        inc = m.group(1)
        if (
            inc.startswith(EXTERNAL)
            or inc.endswith(GENERATED_SUFFIX)
